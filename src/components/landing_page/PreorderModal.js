  ...
  return (
    ...
    {/* <motion.div className="background1" variants={sidebar}> */}
      <motion.div className="preorder-form" variants={sidebar}>
        <img src={CloseIcon} className="close-form-icon" onClick={handleClick}/>
        ...
        >
          ...
          </p>
          {
            alertBox ? 
              <div>
                <FooterSocialLink social="facebook" socialUrl="https://www.facebook.com/darwinautomotivepvtltd"/>
                <FooterSocialLink social="instagram" socialUrl="https://www.instagram.com/darwinautomotive/"/>
                <FooterSocialLink social="linkedin" socialUrl="https://www.linkedin.com/company/darwinautomotive/"/>
                <FooterSocialLink social="whatsapp" socialUrl="https://chat.whatsapp.com/JX9WdAQu9bAKIYplXQC5x6"/>
                <FooterSocialLink social="quora" socialUrl="https://www.quora.com/profile/DARWIN-Automotive-1?ch=10&share=12ca4385&srid=uR5jRd"/>
              </div> : 
              <span></span> 
          }
        </div>
        ...
        <form method="post"> 
          ...
          <input 
            ...
            required
            />
            I have read and also agree to the Privacy Terms under DARWIN Automotive.
