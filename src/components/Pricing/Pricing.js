  ...
  return (
    ...
    <h1 className="headStyling">Pricing</h1>
      ...
      <p className="pricing-info">
        Recommended On‐The‐Road (OTR) retail prices include: delivery charge, additional decals and  stickering, Battery
        half charged, first registration fee at ₹ 500, customs and excise duty (if any).
      </p>
    </div>
    </>
  )
